...
public class EditarContactoConDatos implements Task    {
    ...
    public EditarContactoConDatos(String firstName, String lastName, String birthdate, String email, String phone, String address1, String address2, String city, String state, String postalCode, String country) {
    ...
    public <T extends Actor> void performAs(T t) {
        t.attemptsTo(
                ...
                Click.on(CrearContactoPage.MODIFICAR_BUTTON),
    ...
    public static EditarContactoConDatos conDatos(String firstName, String lastName, String birthdate, String email, String phone, String address1, String address2, String city, String state, String postalCode, String country) {
        return new EditarContactoConDatos(firstName, lastName, birthdate, email, phone, address1, address2, city, state, postalCode, country);
    }
}
